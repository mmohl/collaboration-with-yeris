...
class PenjualanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','prediksi'),
				'users'=>array('*'),
			),
	...
	public function actionPrediksi() {
		...
		if (isset($_POST['Prediksi'])) {
			$model->attributes = $_POST['Prediksi'];
			if ($model->validate()) {
// 				$sources = ['hai'];
				$sources = Penjualan::getSources($model->year);
			}
		}
		
		$this->render('prediksi', ['model'=>$model, 'sources'=>$sources]);
